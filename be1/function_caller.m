...
warning off;
% algo = 3;
% fprintf('Algorithm # %1d, Problem # %1d \n \n',algo,prob)prob = 1;
...
if(algo==1)
    ...
    for i=1:4 % pour chaque point de part
        top_on(i)           =cputime;
        [x_opt(:,i),f_opt(i),conv(i),ite(i),x_seq_SQPi]= ...
            algo_SQP( ...
            f_fun  ,...
            c_fun, ...
            x(i,:)          ,...
...
algo = 2;
if(algo==2)
    x_seq_SQP_BFGS = cell(1,1);
    for i=1:4 % pour chaque point de part
        top_on(i)           =cputime;
        [x_opt(:,i),f_opt(i),conv(i),ite(i),x_seq_SQP_BFGSi]= ...
            algo_SQP_BFGS( ...
            f_fun  ,...
            c_fun, ...
            x(i,:)          ,...
        ...
        x_seq_SQP_BFGS{i} = x_seq_SQP_BFGSi;    
        % On garde les sorties pour l'afichage ..
        temps(i)                        =cputime - top_on(i)              ;
        x_optimale(:,i,algo)            =x_opt(:,i)                       ;
        t_cpu_time(algo ,i)             = temps(i)                        ;
...
algo = 3;
if(algo==3)
    x_seq_SQP_BFGS_SD = cell(1,1);
    for i=1:4
        % pour chaque point de part
        top_on(i) =cputime;
        [x_opt(:,i),f_opt(i),conv(i),ite(i),x_seq_SQP_BFGS_SDi]= ...
        ...
        x_seq_SQP_BFGS_SD{i} = x_seq_SQP_BFGS_SDi;
        % On garde les sorties pour l'afichage ..
        temps(i)                        =cputime - top_on(i)              ;
        x_optimale(:,i,algo)            =x_opt(:,i)                       ;
        t_cpu_time(algo ,i)             = temps(i)                        ;
